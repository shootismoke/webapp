...
sed -i '' -e 's|View privacy policy <a href="_blank"|View privacy policy <a href="https://github.com/shootismoke/policies/blob/main/privacy/index.md"|g' template.html
