...
export function Amazon(): React.ReactElement {
	return (
		<Carousel
			onPageLeftClick={(): void => logEvent('AdSection.PageLeft.Click')}
			onPageRightClick={(): void => logEvent('AdSection.PageRight.Click')}
		>
			{ads.map((ad, adIndex) => (
				<a
